              ...
              <tr>
                ...
                <td>
                  <div class="btn-list flex-nowrap">
                    ...
                    <a href="{{ route('superadmin.tenants.edit', $tenant) }}#password_input" class="btn btn-white btn-sm px-2" title="Reset Owner Password">
                      <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-inline me-1" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none"/><rect x="5" y="11" width="14" height="10" rx="2" /><circle cx="12" cy="16" r="1" /><path d="M8 11v-4a4 4 0 1 1 8 0v4" />
                      </svg>
                      Password
                    </a>
