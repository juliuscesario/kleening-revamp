...
return [
    ...
    'description' => 'Comprehensive API documentation for Kleening Revamp service management system. This API is strictly restricted to the Owner role for reporting and dashboard integration purposes.',
